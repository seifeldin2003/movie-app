...
import 'package:movie_app/features/layout/profile/presentation/bloc/update_profile/update_profile_event.dart';
import 'package:movie_app/features/layout/profile/presentation/bloc/update_profile/update_profile_state.dart';
...
void main() {
  ...
  group('UpdateProfileScreen', () {
    ...
    testWidgets('resolves its Bloc and pre-fills the signed-in name', (
      ...
      getIt.registerLazySingleton<AvatarPhotoPicker>(FakeAvatarPhotoPicker.new);
