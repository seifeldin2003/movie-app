...
import 'package:movie_app/features/trailer/domain/movie_trailer_service.dart';
...
void main() {
  ...
  group('isSameSite', () {
    test('accepts the host itself and its subdomains', () {
      expect(service.isSameSite('https://provider.test/x', 'provider.test'), isTrue);
      expect(
    ...
    test('refuses anywhere else', () {
      expect(service.isSameSite('https://example.com/', 'provider.test'), isFalse);
      expect(
